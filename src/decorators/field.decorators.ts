...
export function IsGregDateValid(
      ...
      validator: {
        ...
        validate(value: string, _args: ValidationArguments) {
          if (typeof value === 'string') {
            return (
              /^2\d{3}-(0[1-9]|1[0-2])-(0[1-9]|[12]\d|3[01])$/.test(value) &&
...
export function IsHijriDateValid(
  validationOptions?: ValidationOptions,
): PropertyDecorator {
  return (object: any, propertyName: string) => {
    registerDecorator({
      ...
      validator: {
        ...
        validate(value: string, _args: ValidationArguments) {
          if (typeof value === 'string') {
            return (
              /^1\d{3}-(0[1-9]|1[0-2])-(0[1-9]|[12]\d|3[01])$/.test(value) &&
              dayjs(value, 'YYYY-MM-DD').isValid()
            );
          }
